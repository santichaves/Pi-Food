...
const alldiets = async () => {
    const infoApiDiets = (await axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=${API_KEY4}&addRecipeInformation=true&instructionsRequired=true&number=100`)).data.results;
